...
void Expr::ExprOperMan::Init() {
  ...
  size_t rc = 0;
  // pi
  Register(ExprOper("pi", "pi_sn", OperCategory::Suffix, 0, OperPriority::L9,
                    OperPriority::Highest, ArgumentsCountVerifier, PINone,
                    PISNHelper));
  // e
  Register(ExprOper("e", "e_sn", OperCategory::Suffix, 0, OperPriority::L9,
                    OperPriority::Highest, ArgumentsCountVerifier, ENone,
                    ESNHelper));
  // + 正号
  Register(ExprOper("+", "positive_ps", OperCategory::Prefix, 1,
                    OperPriority::L9, OperPriority::Highest,
  ...
  // ! 阶乘 后缀
  Register(ExprOper("!", "fact_ss", OperCategory::Suffix, 1, OperPriority::L9,
                    OperPriority::Highest, ArgumentsCountVerifier, FactSingle,
                    FactSSHelper));
  // fact 前/后缀
